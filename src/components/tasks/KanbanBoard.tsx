        ...
        >
          ...
          <div className="flex items-center justify-between px-2">
            <div className="flex items-center gap-3">
              <div className={cn("w-8 h-8 rounded-lg flex items-center justify-center border", column.id === 'done' ? 'bg-emerald-500/10 border-emerald-500/20' : column.id === 'ready' ? 'bg-amber-500/10 border-amber-500/20' : 'bg-white/5 border-white/10')}>
              ...
              <span className="bg-white/5 text-[10px] font-black px-2 py-0.5 rounded-full text-muted-foreground border border-white/5">
            ...
            <button 
              ...
              className="p-2 pill hover:bg-white/10 text-muted-foreground transition-all group/add hover:text-primary"
            >
          ...
          <div className={cn(
            ...
            draggedTaskId ? "bg-primary/5 ring-1 ring-primary/20 ring-dashed" : "bg-transparent"
          )}>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h4 className="text-sm font-black text-foreground italic uppercase tracking-tight group-hover/card:text-primary transition-colors line-clamp-2">
                            {task.title}
                          </h4>
                        </div>
            ...
            {tasks.filter(t => t.status === column.id).length === 0 && !draggedTaskId && (
              <div className="flex-1 border-2 border-dashed border-white/5 rounded-[2rem] flex flex-col items-center justify-center text-center p-6 opacity-30 grayscale hover:grayscale-0 hover:opacity-50 transition-all">
