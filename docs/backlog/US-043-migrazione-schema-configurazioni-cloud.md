# US-024: Migrazione schema e configurazioni dal cloud
...
**Acceptance Criteria**
- [ ] Le migrazioni versionate (US-001) si applicano con successo sull'istanza self-hosted (dipende da US-023)
