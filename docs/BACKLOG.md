...
| [US-006](backlog/US-006-architettura-invio-email-template.md) | Architettura invio email e template promemoria visite mediche | MEDIUM | 3 | DONE |
...
| ID | Story | Priority | Pts | Status |
|---|---|---|---|---|
| [US-007](backlog/US-007-selettore-stagione-globale-header.md) | Selettore stagione globale in header | HIGH | 3 | DONE |
...
| [US-061](backlog/US-061-fix-edge-function-reset-password.md) | Fix invocazione Edge Function reset password assistito | HIGH | 1 | REVIEW |
...
| [US-033](backlog/US-033-pannello-gestione-atleti-squadra.md) | Pannello gestione atleti della squadra | LOW | 3 | DONE |
